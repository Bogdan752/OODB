...
public class XmlWorkClass implements Parser {
    public static void main(String[] args) throws JAXBException {
        ...
        Seller seller = new Seller("Vasya","1234",3);
        Product product = new Product(1, "qwer", 32, 33);
        Product product2 = new Product(2, "ghbdtn", 3545, 1);
        Product product3 = new Product(3, "passw, 1, 34);
